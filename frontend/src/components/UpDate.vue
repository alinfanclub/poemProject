  ...
  <div>
    ...
    <div id="createPost">
      ...
      <div class="submit_btn">
        <button class="" @click="updateThis()">SUBMIT</button>
      </div>
  ...
  methods: {
    async getPostDetail() {
      try {
        ...
        this.$store.state.postData = data;
        this.title = this.$store.state.postData.title;
        this.author = this.$store.state.postData.author;
        this.type = this.$store.state.postData.type;
        this.markdown = this.$store.state.postData.content;
    ...
    async updateThis() {
      try {
        ...
        const con_update = confirm("정말로 수정 하시겠습니까?");
        if (con_update) {
